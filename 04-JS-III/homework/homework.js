...
function cuentoElementos(arreglo) {
    ...
    //Escribe tu código aquí
    let contador = 0;
    arreglo.forEach(element => element > 18 ? contador++ : null);
    return contador;
}
...
function mesesDelAño(array) {
    ...
    // Tu código:
    return array.includes("Enero") && array.includes("Marzo") && array.includes("Noviembre") ?
    array.filter( element => element === "Enero" || element === "Marzo" || element === "Noviembre")
...
function breakStatement(numero) {
    ...
    return newArray.length === 10 ? newArray : "Se interrumpió la ejecución";
}
